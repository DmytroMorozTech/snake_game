...
public class SinglyLinkedList<E> {
    ...
    public void addFirst(E e) {                // Create a new node and add it at the beginning of LinkedList (head side)
    ...
    public void addLast(E e) {                // Create a new node and add it at the end of LinkedList (tail side)
